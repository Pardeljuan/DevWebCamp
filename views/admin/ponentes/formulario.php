<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <label for="apellido" class="formulario__label">Ciudad</label>
        <input type="text" class="formulario__input" id="ciudad" name="ciudad" placeholder="Pais Ponente" value="<?php echo $ponente->ciudad ?? ''; ?>">
    </div>
